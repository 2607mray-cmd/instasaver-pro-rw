...
import { ArrowRight, Clipboard, Download, CheckCircle, Smartphone, Shield, Zap, AlertCircle, Loader2, Copy, Hash, Video, Image as ImageIcon, Play } from 'lucide-react';
import { fetchVideoInfo, getGlobalDownloadCount } from '../services/downloaderService';
...
const Home: React.FC = () => {
    ...
    const [totalDownloads, setTotalDownloads] = useState<number>(26071999);

    useEffect(() => {
        getGlobalDownloadCount().then(count => setTotalDownloads(count));
    }, []);
    ...
    return (
        <div className="flex flex-col min-h-screen">
            <SEO
                title="Download Instagram Videos & Reels Online – InstaSaver Pro"
                description="Free Instagram video downloader tool. Download Instagram videos, reels, stories, and IGTV in HD quality. Fast, secure, and works on all devices. No login required."
            />
            ...
            <section className="relative pt-8 pb-16 lg:pt-28 lg:pb-24 bg-white dark:bg-gray-900 overflow-hidden">
                ...
                <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center z-10">
                    <h1 className="text-3xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-gray-900 dark:text-white mb-4 sm:mb-6 leading-tight">
                        Download Instagram <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 via-pink-500 to-purple-600">Videos & Reels</span> Online
                    </h1>
                    <p className="text-base sm:text-lg md:text-xl text-gray-600 dark:text-gray-300 mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed">
                        Free Instagram video downloader tool. Download Instagram videos, reels, stories, and IGTV in HD quality. Fast, secure, and works on all devices. No login required.
                    </p>
                        ...
                        <form onSubmit={handleDownload} className="relative flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <div className="relative flex-grow">
                                ...
                                <button
                                    type="button"
                                    onClick={handlePaste}
                                    className="absolute right-2 inset-y-0 my-auto h-10 w-10 flex items-center justify-center text-gray-400 hover:text-brand-500 transition-colors rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800"
                    ...
                    <div className="mt-6 text-center animate-in fade-in slide-in-from-bottom-2 duration-700 delay-150">
                        <p className="inline-flex items-center justify-center gap-2 px-4 py-1.5 rounded-full bg-brand-50/50 dark:bg-brand-900/20 text-brand-600 dark:text-brand-300 font-medium text-sm sm:text-base border border-brand-100 dark:border-brand-800/30">
                            <span className="font-bold">{totalDownloads.toLocaleString()}</span> downloads completed 🚀
                        </p>
                    </div>
                                ...
                                <div className="p-6 md:w-1/2 flex flex-col justify-between text-left">
                                    ...
                                    <div className="space-y-3 mt-auto">
                                        ...
                                        <p className="text-xs text-center text-gray-400">
                                            By downloading, you agree to our <Link to="/terms" className="text-brand-600 hover:underline">Terms of Use</Link>.
                                        </p>
                                    </div>
                                </div>
                            </div>
            ...
            {/* NEW: About Instagram Video Downloading Section (SEO Content) */}
            <section className="py-12 sm:py-16 bg-gray-50 dark:bg-gray-800/30" aria-labelledby="about-heading">
                <div className="max-w-4xl mx-auto px-4 sm:px-6">
                    <h2 id="about-heading" className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">About Instagram Video Downloading</h2>

                    <div className="prose prose-lg dark:prose-invert max-w-none">
                        <h3 className="text-xl font-bold text-gray-900 dark:text-white mt-8 mb-4">What is InstaSaver Pro?</h3>
                        <p className="text-gray-600 dark:text-gray-300 mb-6">
                            InstaSaver Pro is a free online Instagram video downloader tool that allows you to download Instagram videos, reels, stories, and IGTV content directly to your device. Whether you want to save inspirational content, educational videos, or entertaining reels, our Instagram video downloader makes it simple and fast.
                        </p>
                        <p className="text-gray-600 dark:text-gray-300 mb-6">
                            Our Instagram reel downloader works with all types of Instagram content. Simply copy the link from Instagram, paste it into our downloader, and get your video in seconds. No software installation required, no registration needed – just a straightforward, user-friendly Instagram video download experience.
                        </p>

                        <h3 className="text-xl font-bold text-gray-900 dark:text-white mt-8 mb-4">Why Download Instagram Videos?</h3>
                        <p className="text-gray-600 dark:text-gray-300 mb-6">
                            There are many legitimate reasons to download Instagram videos and reels. You might want to save educational content for offline viewing, archive your favorite creators' work, or keep memorable moments from friends and family. Content creators often download Instagram reels to study successful video formats and improve their own content strategy.
                        </p>
                        <p className="text-gray-600 dark:text-gray-300 mb-6">
                            With InstaSaver Pro's Instagram video downloader, you can build a personal collection of inspiring content, create compilations for presentations, or simply enjoy your favorite Instagram videos without an internet connection. Our tool preserves the original video quality, ensuring you get the best viewing experience.
                        </p>

                        <h3 className="text-xl font-bold text-gray-900 dark:text-white mt-8 mb-4">Supported Instagram Content Types</h3>
                        <p className="text-gray-600 dark:text-gray-300 mb-4">Our Instagram downloader supports all major content types on the platform:</p>
                        <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-300 mb-6">
                            <li><strong>Instagram Videos:</strong> Download regular Instagram feed videos in HD quality</li>
                            <li><strong>Instagram Reels:</strong> Save trending reels and short-form videos with our Instagram reel downloader</li>
                            <li><strong>Instagram Stories:</strong> Download Instagram stories before they disappear after 24 hours</li>
                            <li><strong>IGTV Videos:</strong> Download long-form IGTV content for offline viewing</li>
                            <li><strong>Instagram Carousel:</strong> Extract videos from multi-media posts</li>
                        </ul>

                        <h3 className="text-xl font-bold text-gray-900 dark:text-white mt-8 mb-4">Device Compatibility</h3>
                        <p className="text-gray-600 dark:text-gray-300 mb-6">
                            InstaSaver Pro works seamlessly across all devices and platforms. Download Instagram videos on your iPhone, Android smartphone, Windows PC, Mac, iPad, or any tablet. Our responsive design ensures the Instagram video downloader interface looks perfect and functions smoothly regardless of your screen size.
                        </p>
                        <p className="text-gray-600 dark:text-gray-300 mb-6">
                            Mobile users can download Instagram reels directly to their camera roll, while desktop users can save videos to any folder. The download process is optimized for each platform, providing the best possible experience whether you're using Chrome, Safari, Firefox, Edge, or any other modern browser.
                        </p>
                    </div>
                </div>
            </section>

            {/* NEW: Legal & Ethical Use Section (SEO Content) */}
            <section className="py-12 sm:py-16 bg-white dark:bg-gray-900" aria-labelledby="legal-heading">
                <div className="max-w-4xl mx-auto px-4 sm:px-6">
                    <h2 id="legal-heading" className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Legal & Ethical Use of Instagram Video Downloader</h2>

                    <div className="prose prose-lg dark:prose-invert max-w-none">
                        <h3 className="text-xl font-bold text-gray-900 dark:text-white mt-8 mb-4">Copyright and Fair Use</h3>
                        <p className="text-gray-600 dark:text-gray-300 mb-6">
                            When you download Instagram videos using InstaSaver Pro, you must respect copyright laws and the intellectual property rights of content creators. Our Instagram video downloader is intended for personal use only. Downloaded content should not be redistributed, sold, or used for commercial purposes without explicit permission from the original creator.
                        </p>
                        <p className="text-gray-600 dark:text-gray-300 mb-6">
                            Always credit the original creator when sharing downloaded Instagram videos or reels. If you're a content creator yourself, downloading Instagram videos for inspiration or educational purposes falls under fair use, but direct copying or re-uploading without permission violates Instagram's terms of service and copyright law. For more information, visit the <a href="https://help.instagram.com/581066165581870" target="_blank" rel="noopener noreferrer" className="text-brand-600 hover:underline">Instagram Help Center</a>.
                        </p>

                        <h3 className="text-xl font-bold text-gray-900 dark:text-white mt-8 mb-4">Privacy Considerations</h3>
                        <p className="text-gray-600 dark:text-gray-300 mb-6">
                            InstaSaver Pro respects user privacy. Our Instagram video downloader only works with public Instagram content. We cannot and will not help you download private Instagram videos or content from accounts you don't have permission to view. Always respect the privacy settings chosen by Instagram users.
                        </p>
                        <p className="text-gray-600 dark:text-gray-300 mb-6">
                            We don't store any downloaded videos on our servers, and we don't track what content you download. Your use of our Instagram reel downloader is completely anonymous and private. Read our <Link to="/privacy" className="text-brand-600 hover:underline">Privacy Policy</Link> for more details.
                        </p>

                        <h3 className="text-xl font-bold text-gray-900 dark:text-white mt-8 mb-4">Responsible Usage Guidelines</h3>
                        <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-300 mb-6">
                            <li>Only download Instagram videos for personal, non-commercial use</li>
                            <li>Respect the original creator's copyright and intellectual property</li>
                            <li>Don't re-upload downloaded content as your own</li>
                            <li>Give proper credit when sharing downloaded Instagram reels</li>
                            <li>Don't use our Instagram video downloader to harass or stalk other users</li>
                    ...
                    <div className="space-y-4">
                        {[
                            ...FAQS,
                            {
                                ...
                                answer: "Absolutely! Our Instagram reel downloader supports all Instagram reels. Just copy the reel link from Instagram, paste it into our downloader, and save the reel in HD quality to your device."
                            },
                            {
                                question: "Does this work on mobile devices?",
                                answer: "Yes! InstaSaver Pro works perfectly on all mobile devices including iPhone, Android, iPad, and tablets. Download Instagram videos on the go from any device with a web browser."
                            },
                            {
                                question: "Can I download private Instagram videos?",
                                answer: "No. Our Instagram video downloader only works with public content. We respect user privacy and Instagram's privacy settings. You cannot download videos from private accounts unless you have permission to view them."
                            },
                            {
                                question: "What video quality can I download?",
                                answer: "InstaSaver Pro offers multiple quality options. You can download Instagram videos in HD (high definition) or SD (standard definition) depending on the original upload quality and your preference."
                            },
                            {
                                question: "Is it legal to download Instagram videos?",
                                answer: "Downloading Instagram videos for personal use is generally acceptable, but you must respect copyright laws. Don't redistribute, sell, or use downloaded content commercially without the creator's permission. Always credit the original creator."
                            }
                        ].map((faq, i) => (
